...
def compare(user_score, computer_score): 
    if user_score == computer_score:
      ...
      return "you win, computer went over the score"
...
def play_game():
  ...
  for _ in range(2):
    # new_card = dealcard()
    # user_cards += new_card # it will show int error

    # new_card = [deal_card()]
    # user_cards += new_card
    # user_cards.extend(new_card) #whatever it in the brackets it has to be a list itself
...
while input("Do you want to plaay a game of Blackjack ? Type 'y' or 'n': ") == "y":
  clear()
  play_game()